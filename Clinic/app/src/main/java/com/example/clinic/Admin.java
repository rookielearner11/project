        ...
        serviceAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!service.isEmpty() && !serviceWorker.isEmpty() && !serviceRole.isEmpty()) {
                    DatabaseReference myRef1 = database.getReference("Users/services/" + service);
                    DatabaseReference myRef2 = database.getReference("Users/services/" + service + "/Name");
                    DatabaseReference myRef3 = database.getReference("Users/services/" + service + "/Role");
